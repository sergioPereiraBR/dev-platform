...
class ConfigurationFacade:
    ...
    def __init__(
        ...
        self._environment: str = os.getenv("ENVIRONMENT", "production")
...
# Se desejar, pode adicionar um parâmetro de controle para permitir o reset do singleton
# apenas em ambiente de teste, mas como está, já é seguro se usado corretamente.
